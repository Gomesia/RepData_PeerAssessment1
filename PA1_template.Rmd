...
author: "Melissa Berkheimer"
output: html_document
---

##Abstract
This document examines the movement data of one indiviual at 5 minute increments 
...
Each day was split into a total of 288 5 minute intervals. The activity across each time interval was averaged to show the user's pattern of activity.
